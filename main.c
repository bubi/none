...
#define DEVICE_NAME                      "noneNordic"                                /**< Name of device. Will be included in the advertising data. */
#define MANUFACTURER_NAME                "noneSemi"                   						  /**< Manufacturer. Will be passed to Device Information Service. */
