...
static app_timer_t m_leds_timer_id_data = { {0} }; static const app_timer_id_t m_leds_timer_id = &m_leds_timer_id_data;
static app_timer_t m_alert_timer_id_data = { {0} }; static const app_timer_id_t m_alert_timer_id = &m_alert_timer_id_data;
...
static app_timer_t m_button_timer_id_data = { {0} }; static const app_timer_id_t m_button_timer_id = &m_button_timer_id_data;
static void bsp_button_event_handler(uint8_t pin_no, uint8_t button_action);


static const uint32_t m_buttons_list[4] = { 13, 14, 15, 16 };


static const app_button_cfg_t app_buttons[4] =
{

    {13, 0, NRF_GPIO_PIN_PULLUP, bsp_button_event_handler},



    {14, 0, NRF_GPIO_PIN_PULLUP, bsp_button_event_handler},



    {15, 0, NRF_GPIO_PIN_PULLUP, bsp_button_event_handler},



    {16, 0, NRF_GPIO_PIN_PULLUP, bsp_button_event_handler},
...
static void bsp_button_event_handler(uint8_t pin_no, uint8_t button_action)
{
    ...
    if (button < 4)
    {
        switch (button_action)
        {
            case 1:
                ...
                {
                    err_code = app_timer_start(m_button_timer_id, (m_app_ticks_per_100ms * ((1000) / 100)), (void*)&current_long_push_pin_no);
                    if (err_code == ((0x0) + 0))
                    {
    ...
    if ((event != BSP_EVENT_NOTHING) && (m_registered_callback != 0))
    {
...
static uint32_t bsp_led_indication(bsp_indication_t indicate)
{
    ...
    switch (indicate)
    {
        case BSP_INDICATE_IDLE:
            do { ((NRF_GPIO_Type *) 0x50000000UL)->OUTSET = (((1<<17) | (1<<18) | (1<<19) | (1<<20)) & ~m_alert_mask) & (((1<<17) | (1<<18) | (1<<19) | (1<<20)) & ((1<<17) | (1<<18) | (1<<19) | (1<<20))); ((NRF_GPIO_Type *) 0x50000000UL)->OUTCLR = (((1<<17) | (1<<18) | (1<<19) | (1<<20)) & ~m_alert_mask) & (((1<<17) | (1<<18) | (1<<19) | (1<<20)) & ~((1<<17) | (1<<18) | (1<<19) | (1<<20))); } while (0);
            m_stable_state = indicate;
            break;

        case BSP_INDICATE_SCANNING:
        case BSP_INDICATE_ADVERTISING:
            do { ((NRF_GPIO_Type *) 0x50000000UL)->OUTSET = (((1<<17) | (1<<18) | (1<<19) | (1<<20)) & ~(1<<17) & ~m_alert_mask) & (((1<<17) | (1<<18) | (1<<19) | (1<<20)) & ((1<<17) | (1<<18) | (1<<19) | (1<<20))); ((NRF_GPIO_Type *) 0x50000000UL)->OUTCLR = (((1<<17) | (1<<18) | (1<<19) | (1<<20)) & ~(1<<17) & ~m_alert_mask) & (((1<<17) | (1<<18) | (1<<19) | (1<<20)) & ~((1<<17) | (1<<18) | (1<<19) | (1<<20))); } while (0);

            
            if ((((1<<17)) & (((NRF_GPIO_Type *) 0x50000000UL)->OUT ^ ((1<<17) | (1<<18) | (1<<19) | (1<<20))) ))
            {
                do { ((NRF_GPIO_Type *) 0x50000000UL)->OUTSET = ((1<<17)) & (((1<<17) | (1<<18) | (1<<19) | (1<<20)) & ((1<<17) | (1<<18) | (1<<19) | (1<<20))); ((NRF_GPIO_Type *) 0x50000000UL)->OUTCLR = ((1<<17)) & (((1<<17) | (1<<18) | (1<<19) | (1<<20)) & ~((1<<17) | (1<<18) | (1<<19) | (1<<20))); } while (0);
                next_delay = indicate ==
            ...
            {
                do { ((NRF_GPIO_Type *) 0x50000000UL)->OUTCLR = ((1<<17)) & (((1<<17) | (1<<18) | (1<<19) | (1<<20)) & ((1<<17) | (1<<18) | (1<<19) | (1<<20))); ((NRF_GPIO_Type *) 0x50000000UL)->OUTSET = ((1<<17)) & (((1<<17) | (1<<18) | (1<<19) | (1<<20)) & ~((1<<17) | (1<<18) | (1<<19) | (1<<20))); } while (0);
                next_delay = indicate ==
        ...
        case BSP_INDICATE_SENT_OK:
            ...
            do { uint32_t gpio_state = ((NRF_GPIO_Type *) 0x50000000UL)->OUT; ((NRF_GPIO_Type *) 0x50000000UL)->OUTSET = (((1<<18)) & ~gpio_state); ((NRF_GPIO_Type *) 0x50000000UL)->OUTCLR = (((1<<18)) & gpio_state); } while (0);
        ...
        case BSP_INDICATE_FATAL_ERROR:
            ...
            do { ((NRF_GPIO_Type *) 0x50000000UL)->OUTCLR = (((1<<17) | (1<<18) | (1<<19) | (1<<20))) & (((1<<17) | (1<<18) | (1<<19) | (1<<20)) & ((1<<17) | (1<<18) | (1<<19) | (1<<20))); ((NRF_GPIO_Type *) 0x50000000UL)->OUTSET = (((1<<17) | (1<<18) | (1<<19) | (1<<20))) & (((1<<17) | (1<<18) | (1<<19) | (1<<20)) & ~((1<<17) | (1<<18) | (1<<19) | (1<<20))); } while (0);
            m_stable_state = indicate;
            break;
        ...
        case BSP_INDICATE_ALERT_OFF:
            ...
            if (next_delay && (err_code == ((0x0) + 0)))
            {
                ...
                do { ((NRF_GPIO_Type *) 0x50000000UL)->OUTCLR = (m_alert_mask) & (((1<<17) | (1<<18) | (1<<19) | (1<<20)) & ((1<<17) | (1<<18) | (1<<19) | (1<<20))); ((NRF_GPIO_Type *) 0x50000000UL)->OUTSET = (m_alert_mask) & (((1<<17) | (1<<18) | (1<<19) | (1<<20)) & ~((1<<17) | (1<<18) | (1<<19) | (1<<20))); } while (0);
            }
            else
            {
                do { ((NRF_GPIO_Type *) 0x50000000UL)->OUTSET = (m_alert_mask) & (((1<<17) | (1<<18) | (1<<19) | (1<<20)) & ((1<<17) | (1<<18) | (1<<19) | (1<<20))); ((NRF_GPIO_Type *) 0x50000000UL)->OUTCLR = (m_alert_mask) & (((1<<17) | (1<<18) | (1<<19) | (1<<20)) & ~((1<<17) | (1<<18) | (1<<19) | (1<<20))); } while (0);
                m_alert_mask = 0;
            }
            break;

        case BSP_INDICATE_USER_STATE_OFF:
            do { ((NRF_GPIO_Type *) 0x50000000UL)->OUTSET = (((1<<17) | (1<<18) | (1<<19) | (1<<20))) & (((1<<17) | (1<<18) | (1<<19) | (1<<20)) & ((1<<17) | (1<<18) | (1<<19) | (1<<20))); ((NRF_GPIO_Type *) 0x50000000UL)->OUTCLR = (((1<<17) | (1<<18) | (1<<19) | (1<<20))) & (((1<<17) | (1<<18) | (1<<19) | (1<<20)) & ~((1<<17) | (1<<18) | (1<<19) | (1<<20))); } while (0);
            m_stable_state = indicate;
            break;

        case BSP_INDICATE_USER_STATE_0:
            do { ((NRF_GPIO_Type *) 0x50000000UL)->OUTSET = (((1<<17) | (1<<18) | (1<<19) | (1<<20)) & ~(1<<17)) & (((1<<17) | (1<<18) | (1<<19) | (1<<20)) & ((1<<17) | (1<<18) | (1<<19) | (1<<20))); ((NRF_GPIO_Type *) 0x50000000UL)->OUTCLR = (((1<<17) | (1<<18) | (1<<19) | (1<<20)) & ~(1<<17)) & (((1<<17) | (1<<18) | (1<<19) | (1<<20)) & ~((1<<17) | (1<<18) | (1<<19) | (1<<20))); } while (0);
            do { ((NRF_GPIO_Type *) 0x50000000UL)->OUTCLR = ((1<<17)) & (((1<<17) | (1<<18) | (1<<19) | (1<<20)) & ((1<<17) | (1<<18) | (1<<19) | (1<<20))); ((NRF_GPIO_Type *) 0x50000000UL)->OUTSET = ((1<<17)) & (((1<<17) | (1<<18) | (1<<19) | (1<<20)) & ~((1<<17) | (1<<18) | (1<<19) | (1<<20))); } while (0);
            m_stable_state = indicate;
            break;

        case BSP_INDICATE_USER_STATE_1:
            do { ((NRF_GPIO_Type *) 0x50000000UL)->OUTSET = (((1<<17) | (1<<18) | (1<<19) | (1<<20)) & ~(1<<18)) & (((1<<17) | (1<<18) | (1<<19) | (1<<20)) & ((1<<17) | (1<<18) | (1<<19) | (1<<20))); ((NRF_GPIO_Type *) 0x50000000UL)->OUTCLR = (((1<<17) | (1<<18) | (1<<19) | (1<<20)) & ~(1<<18)) & (((1<<17) | (1<<18) | (1<<19) | (1<<20)) & ~((1<<17) | (1<<18) | (1<<19) | (1<<20))); } while (0);
            do { ((NRF_GPIO_Type *) 0x50000000UL)->OUTCLR = ((1<<18)) & (((1<<17) | (1<<18) | (1<<19) | (1<<20)) & ((1<<17) | (1<<18) | (1<<19) | (1<<20))); ((NRF_GPIO_Type *) 0x50000000UL)->OUTSET = ((1<<18)) & (((1<<17) | (1<<18) | (1<<19) | (1<<20)) & ~((1<<17) | (1<<18) | (1<<19) | (1<<20))); } while (0);
            m_stable_state = indicate;
            break;

        case BSP_INDICATE_USER_STATE_2:
            do { ((NRF_GPIO_Type *) 0x50000000UL)->OUTSET = (((1<<17) | (1<<18) | (1<<19) | (1<<20)) & ~((1<<17) | (1<<18))) & (((1<<17) | (1<<18) | (1<<19) | (1<<20)) & ((1<<17) | (1<<18) | (1<<19) | (1<<20))); ((NRF_GPIO_Type *) 0x50000000UL)->OUTCLR = (((1<<17) | (1<<18) | (1<<19) | (1<<20)) & ~((1<<17) | (1<<18))) & (((1<<17) | (1<<18) | (1<<19) | (1<<20)) & ~((1<<17) | (1<<18) | (1<<19) | (1<<20))); } while (0);
            do { ((NRF_GPIO_Type *) 0x50000000UL)->OUTCLR = ((1<<17) | (1<<18)) & (((1<<17) | (1<<18) | (1<<19) | (1<<20)) & ((1<<17) | (1<<18) | (1<<19) | (1<<20))); ((NRF_GPIO_Type *) 0x50000000UL)->OUTSET = ((1<<17) | (1<<18)) & (((1<<17) | (1<<18) | (1<<19) | (1<<20)) & ~((1<<17) | (1<<18) | (1<<19) | (1<<20))); } while (0);
            m_stable_state = indicate;
            break;
...
{
    ((void)(p_context));
    do { uint32_t gpio_state = ((NRF_GPIO_Type *) 0x50000000UL)->OUT; ((NRF_GPIO_Type *) 0x50000000UL)->OUTSET = (((1<<19)) & ~gpio_state); ((NRF_GPIO_Type *) 0x50000000UL)->OUTCLR = (((1<<19)) & gpio_state); } while (0);
}
...
#line 567 "..\\..\\..\\..\\..\\bsp\\bsp.c"
    ...
    {
        do { ((NRF_GPIO_Type *) 0x50000000UL)->OUTSET = (((1<<17) | (1<<18) | (1<<19) | (1<<20))) & (((1<<17) | (1<<18) | (1<<19) | (1<<20)) & ((1<<17) | (1<<18) | (1<<19) | (1<<20))); ((NRF_GPIO_Type *) 0x50000000UL)->OUTCLR = (((1<<17) | (1<<18) | (1<<19) | (1<<20))) & (((1<<17) | (1<<18) | (1<<19) | (1<<20)) & ~((1<<17) | (1<<18) | (1<<19) | (1<<20))); } while (0);
        ((NRF_GPIO_Type *) 0x50000000UL)->DIRSET = ((1<<17) | (1<<18) | (1<<19) | (1<<20));
    }
...
uint32_t bsp_wakeup_buttons_set(uint32_t wakeup_buttons)
{
    ...
    {
        uint32_t new_cnf = ((NRF_GPIO_Type *) 0x50000000UL)->PIN_CNF[m_buttons_list[i]];
        uint32_t new_sense = ((1 << i) & wakeup_buttons) ? (3UL) : (0UL);
        new_cnf &= ~(0x3UL << (16UL));
        new_cnf |= (new_sense << (16UL));
        ((NRF_GPIO_Type *) 0x50000000UL)->PIN_CNF[m_buttons_list[i]] = new_cnf;
    }
    return ((0x0) + 0);
