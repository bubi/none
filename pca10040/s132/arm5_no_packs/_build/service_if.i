...
typedef enum
{ 
    BLE_DIS_MANUFACTURER_NAME_STRING_EVT_NOTIFICATION_ENABLED,   
    BLE_DIS_MANUFACTURER_NAME_STRING_EVT_NOTIFICATION_DISABLED,  
    BLE_DIS_MODEL_NUMBER_STRING_EVT_NOTIFICATION_ENABLED,   
    BLE_DIS_MODEL_NUMBER_STRING_EVT_NOTIFICATION_DISABLED,  
    BLE_DIS_SERIAL_NUMBER_STRING_EVT_NOTIFICATION_ENABLED,   
    BLE_DIS_SERIAL_NUMBER_STRING_EVT_NOTIFICATION_DISABLED,  
    BLE_DIS_HARDWARE_REVISION_STRING_EVT_NOTIFICATION_ENABLED,   
    BLE_DIS_HARDWARE_REVISION_STRING_EVT_NOTIFICATION_DISABLED,  
    BLE_DIS_FIRMWARE_REVISION_STRING_EVT_NOTIFICATION_ENABLED,   
    BLE_DIS_FIRMWARE_REVISION_STRING_EVT_NOTIFICATION_DISABLED,  
    BLE_DIS_SOFTWARE_REVISION_STRING_EVT_NOTIFICATION_ENABLED,   
    BLE_DIS_SOFTWARE_REVISION_STRING_EVT_NOTIFICATION_DISABLED,  
    BLE_DIS_SYSTEM_ID_EVT_NOTIFICATION_ENABLED,   
    BLE_DIS_SYSTEM_ID_EVT_NOTIFICATION_DISABLED,  
    BLE_DIS_IEEE_11073_20601_REGULATORY_CERTIFICATION_DATA_LIST_EVT_NOTIFICATION_ENABLED,   
    BLE_DIS_IEEE_11073_20601_REGULATORY_CERTIFICATION_DATA_LIST_EVT_NOTIFICATION_DISABLED,  
    BLE_DIS_PNP_ID_EVT_NOTIFICATION_ENABLED,   
    BLE_DIS_PNP_ID_EVT_NOTIFICATION_DISABLED,  
} ble_dis_evt_type_t;
...
typedef struct
{
    ble_dis_evt_handler_t     evt_handler;  
    ble_dis_manufacturer_name_string_t ble_dis_manufacturer_name_string_initial_value;   
    ble_dis_model_number_string_t ble_dis_model_number_string_initial_value;   
    ble_dis_serial_number_string_t ble_dis_serial_number_string_initial_value;   
    ble_dis_hardware_revision_string_t ble_dis_hardware_revision_string_initial_value;   
    ble_dis_firmware_revision_string_t ble_dis_firmware_revision_string_initial_value;   
    ble_dis_software_revision_string_t ble_dis_software_revision_string_initial_value;   
    ble_dis_system_id_t ble_dis_system_id_initial_value;   
    ble_dis_ieee_11073_20601_regulatory_certification_data_list_t ble_dis_ieee_11073_20601_regulatory_certification_data_list_initial_value;   
    ble_dis_pnp_id_t ble_dis_pnp_id_initial_value;   
} ble_dis_init_t;
...
struct ble_dis_s
{
    ble_dis_evt_handler_t evt_handler;  
    uint16_t service_handle;  
    ble_gatts_char_handles_t manufacturer_name_string_handles;  
    ble_gatts_char_handles_t model_number_string_handles;  
    ble_gatts_char_handles_t serial_number_string_handles;  
    ble_gatts_char_handles_t hardware_revision_string_handles;  
    ble_gatts_char_handles_t firmware_revision_string_handles;  
    ble_gatts_char_handles_t software_revision_string_handles;  
    ble_gatts_char_handles_t system_id_handles;  
    ble_gatts_char_handles_t ieee_11073_20601_regulatory_certification_data_list_handles;  
...
uint32_t bluetooth_init(void)
{
    ...
    bas_init.is_battery_level_notify_supported = 1;
