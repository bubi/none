...
#line 16 "..\\..\\..\\..\\..\\..\\components\\ble\\nrf_ble_qwr\\nrf_ble_qwr.c"
#line 17 "..\\..\\..\\..\\..\\..\\components\\ble\\nrf_ble_qwr\\nrf_ble_qwr.c"
#line 18 "..\\..\\..\\..\\..\\..\\components\\ble\\nrf_ble_qwr\\nrf_ble_qwr.c"
#line 19 "..\\..\\..\\..\\..\\..\\components\\ble\\nrf_ble_qwr\\nrf_ble_qwr.c"
#line 20 "..\\..\\..\\..\\..\\..\\components\\ble\\nrf_ble_qwr\\nrf_ble_qwr.c"
#line 21 "..\\..\\..\\..\\..\\..\\components\\ble\\nrf_ble_qwr\\nrf_ble_qwr.c"

#line 25 "..\\..\\..\\..\\..\\..\\components\\ble\\nrf_ble_qwr\\nrf_ble_qwr.c"

ret_code_t nrf_ble_qwr_init(nrf_ble_qwr_t            * p_qwr,
                            nrf_ble_qwr_init_t const * p_qwr_init)
{
    do { if ((((p_qwr) == 0))) { return ((0x0) + 14); } } while (0);
    do { if ((((p_qwr_init) == 0))) { return ((0x0) + 14); } } while (0);
    ...
    p_qwr->is_user_mem_reply_pending = 0;
...
ret_code_t nrf_ble_qwr_attr_register(nrf_ble_qwr_t * p_qwr, uint16_t attr_handle)
{
    ...
    if (p_qwr->nb_registered_attr == 10)
    {
        return (((0x0) + 4));
    }

    if (attr_handle == 0x0000)
    {
        return ((0x0) + 7);
    }
...
{
    do { if ((((p_qwr) == 0))) { return ((0x0) + 14); } } while (0);
    do { if ((((p_mem) == 0))) { return ((0x0) + 14); } } while (0);
    do { if ((((p_len) == 0))) { return ((0x0) + 14); } } while (0);
    do { if (!(((p_qwr->initialized == 0xDE)))) { return ((0x0) + 8); } } while (0);
                                ...
                                ble_common_evt_t const * p_common_evt)
{
    if (p_common_evt->conn_handle == p_qwr->conn_handle)
    {
        ...
        {
            p_qwr->is_user_mem_reply_pending = 1;
        }
        else
        {
...
void nrf_ble_qwr_on_ble_evt(nrf_ble_qwr_t * p_qwr,
                            ble_evt_t     * p_ble_evt)
{
    do { if (((((p_qwr) == 0)))) { return ; } } while (0);
    do { if (((((p_ble_evt) == 0)))) { return ; } } while (0);
