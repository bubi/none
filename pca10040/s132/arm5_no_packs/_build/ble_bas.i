...
uint32_t ble_bas_init(ble_bas_t * p_bas, const ble_bas_init_t * p_bas_init)
{
    ...
    uint8_t battery_level_encoded_value[((23) - 1 - 2)];
    ...
    add_battery_level_params.max_len             = ((23) - 1 - 2);
    ...
    characteristic_presentation_format.format     = 0x0A;   
    characteristic_presentation_format.desc       = 0x01; 
    characteristic_presentation_format.exponent   = -2;                           
    characteristic_presentation_format.name_space = 0x01; 
