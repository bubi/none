...
#line 14 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\spi_master\\nrf_drv_spi.c"
...
#line 19 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\spi_master\\nrf_drv_spi.c"
...
#line 20 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\spi_master\\nrf_drv_spi.c"
#line 1 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\hal\\nrf_gpio.h"
...
#line 21 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\spi_master\\nrf_drv_spi.c"
#line 1 "..\\..\\..\\..\\..\\..\\components\\libraries\\util\\nrf_assert.h"
...
#line 22 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\spi_master\\nrf_drv_spi.c"
...
#line 23 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\spi_master\\nrf_drv_spi.c"
...
#line 34 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\spi_master\\nrf_drv_spi.c"

#line 45 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\spi_master\\nrf_drv_spi.c"
...
#line 79 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\spi_master\\nrf_drv_spi.c"
...
typedef struct
{
    ...
    volatile _Bool         transfer_in_progress;
...
static spi_control_block_t m_cb[(1+0+0)];

#line 136 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\spi_master\\nrf_drv_spi.c"
...
#line 157 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\spi_master\\nrf_drv_spi.c"
    ...
    ((NRF_GPIO_Type *) 0x50000000UL)->PIN_CNF[p_config->sck_pin] =
        ((1UL)        << (0UL))
      | ((0UL)     << (1UL))
      | ((0UL)     << (2UL))
      | ((0UL)        << (8UL))
...
#line 229 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\spi_master\\nrf_drv_spi.c"
    { NRF_SPI_Type * p_spi = p_instance ->p_registers; nrf_spi_pins_set(p_spi, p_config->sck_pin, mosi_pin, miso_pin); nrf_spi_frequency_set(p_spi, (nrf_spi_frequency_t)p_config->frequency); nrf_spi_configure(p_spi, (nrf_spi_mode_t)p_config->mode, (nrf_spi_bit_order_t)p_config->bit_order); m_cb[p_instance ->drv_inst_idx]. orc = p_config->orc; if (p_cb->handler) { nrf_spi_int_enable(p_spi, NRF_SPI_INT_READY_MASK); } nrf_spi_enable(p_spi); }
#line 248 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\spi_master\\nrf_drv_spi.c"
    ...
    p_cb->transfer_in_progress = 0;
    p_cb->state = NRF_DRV_STATE_INITIALIZED;

    if ((0 >= 3U) && (3U <= 0)) { nrf_log_frontend_std_0(3U, "SPI" ":" "INFO:" "Init\r\n"); };
...
#line 290 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\spi_master\\nrf_drv_spi.c"
    { NRF_SPI_Type * p_spi = p_instance ->p_registers; if (p_cb->handler) { nrf_spi_int_disable(p_spi, 0xFFFFFFFF); } nrf_spi_disable(p_spi); }
#line 300 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\spi_master\\nrf_drv_spi.c"
                                ...
                                uint8_t         rx_buffer_length)
{
    ...
    if ((0 >= 3U) && (3U <= 0)) { nrf_log_frontend_std_2(3U, "SPI" ":" "INFO:" "Transfer tx_len:%d, rx_len:%d\r\n", tx_buffer_length, rx_buffer_length); };
    if ((0 >= 4U) && (4U <= 0)) { nrf_log_frontend_std_0(4U, "SPI" ":" "DEBUG:" "Tx data:\r\n"); };
    if ((0 >= 4U) && (4U <= 0)) { nrf_log_frontend_hexdump(4U,  "SPI" ":" "DEBUG:" "\r\n", ((uint8_t *)p_tx_buffer), (tx_buffer_length)); };
...
static _Bool transfer_byte(NRF_SPI_Type * p_spi, spi_control_block_t * p_cb)
{
...
#line 508 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\spi_master\\nrf_drv_spi.c"
                            ...
                            uint32_t                        flags)
{
    ...
    {
        if (p_cb->handler && !(flags & ((1UL << 4) | (1UL << 2))))
        {
            p_cb->transfer_in_progress = 1;
        }
    }
    ...
    { if (flags) { p_cb->transfer_in_progress = 0; return ((0x0) + 6); } spi_xfer(p_instance ->p_registers, p_cb, p_xfer_desc); return ((0x0) + 0); }
#line 552 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\spi_master\\nrf_drv_spi.c"
}
#line 577 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\spi_master\\nrf_drv_spi.c"
...
{
    spi_control_block_t * p_cb  = &m_cb[0];



        irq_handler_spi(((NRF_SPI_Type *) 0x40003000UL), p_cb);

}


#line 615 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\spi_master\\nrf_drv_spi.c"
