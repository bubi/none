...
#line 14 "..\\..\\..\\..\\..\\..\\components\\ble\\peer_manager\\security_manager.c"
...
#line 18 "..\\..\\..\\..\\..\\..\\components\\ble\\peer_manager\\security_manager.h"
...
#line 19 "..\\..\\..\\..\\..\\..\\components\\ble\\peer_manager\\security_manager.h"
...
#line 20 "..\\..\\..\\..\\..\\..\\components\\ble\\peer_manager\\security_manager.h"
#line 21 "..\\..\\..\\..\\..\\..\\components\\ble\\peer_manager\\security_manager.h"
...
#line 22 "..\\..\\..\\..\\..\\..\\components\\ble\\peer_manager\\security_manager.h"
...
#line 18 "..\\..\\..\\..\\..\\..\\components\\ble\\peer_manager\\security_dispatcher.h"
#line 19 "..\\..\\..\\..\\..\\..\\components\\ble\\peer_manager\\security_dispatcher.h"
#line 20 "..\\..\\..\\..\\..\\..\\components\\ble\\peer_manager\\security_dispatcher.h"
#line 21 "..\\..\\..\\..\\..\\..\\components\\ble\\peer_manager\\security_dispatcher.h"
#line 22 "..\\..\\..\\..\\..\\..\\components\\ble\\peer_manager\\security_dispatcher.h"
...
#line 187 "..\\..\\..\\..\\..\\..\\components\\ble\\peer_manager\\security_dispatcher.h"
...
#line 23 "..\\..\\..\\..\\..\\..\\components\\ble\\peer_manager\\security_manager.h"
...
#line 16 "..\\..\\..\\..\\..\\..\\components\\ble\\peer_manager\\security_manager.c"
...
#line 18 "..\\..\\..\\..\\..\\..\\components\\ble\\peer_manager\\security_manager.c"
#line 19 "..\\..\\..\\..\\..\\..\\components\\ble\\peer_manager\\security_manager.c"
...
#line 20 "..\\..\\..\\..\\..\\..\\components\\ble\\peer_manager\\security_manager.c"
...
#line 21 "..\\..\\..\\..\\..\\..\\components\\ble\\peer_manager\\security_manager.c"
...
#line 18 "..\\..\\..\\..\\..\\..\\components\\ble\\peer_manager\\id_manager.h"
#line 19 "..\\..\\..\\..\\..\\..\\components\\ble\\peer_manager\\id_manager.h"
#line 20 "..\\..\\..\\..\\..\\..\\components\\ble\\peer_manager\\id_manager.h"
#line 21 "..\\..\\..\\..\\..\\..\\components\\ble\\peer_manager\\id_manager.h"
#line 22 "..\\..\\..\\..\\..\\..\\components\\ble\\peer_manager\\id_manager.h"
...
#line 22 "..\\..\\..\\..\\..\\..\\components\\ble\\peer_manager\\security_manager.c"
...
static _Bool                            m_sec_params_valid;
...
static void flags_set_from_err_code(uint16_t conn_handle, ret_code_t err_code, _Bool params_reply)
{
    _Bool flag_value_flash_full = 0;
    _Bool flag_value_busy       = 0;
         ...
         || (err_code == ((0x0) + 0)))
    {
        ...
        {
            flag_value_busy       = 0;
            flag_value_flash_full = 1;
        }
        else if (err_code == ((0x0) + 17))
        {
            flag_value_busy       = 1;
            flag_value_flash_full = 0;
        }
...
static ret_code_t link_secure(uint16_t conn_handle, _Bool null_params, _Bool force_repairing, _Bool send_events)
{
    ret_code_t err_code;
    ...
    if (null_params)
    {
        err_code = smd_link_secure(conn_handle, 0, force_repairing);
    }
    else
    {
    ...
    flags_set_from_err_code(conn_handle, err_code, 0);
...
static void smd_params_reply_perform(uint16_t conn_handle)
{
    ...
    if (  (ble_conn_state_role(conn_handle) == 0x1)
        && im_peer_id_get_by_conn_handle(conn_handle) != 0xFFFF)
    {
        
        ble_conn_state_user_flag_set(conn_handle, m_flag_reject_pairing, 1);
        send_config_req(conn_handle);
    }
    else
    {
        ble_conn_state_user_flag_set(conn_handle, m_flag_reject_pairing, 0);
    }
    ...
    {
        err_code = smd_params_reply(conn_handle, 0, 0);
    }

    flags_set_from_err_code(conn_handle, err_code, 1);
    events_send_from_err_code(conn_handle, err_code);
}
...
void sm_smd_evt_handler(smd_evt_t const * p_event)
{
    switch (p_event->evt_id)
    {
        ...
        case SMD_EVT_SLAVE_SECURITY_REQ:
        {
            ...
            else if ((_Bool)m_sec_params.bond < (_Bool)p_event->params.slave_security_req.bond)
            {
                null_params = 1;
            }
            else if ((_Bool)m_sec_params.mitm < (_Bool)p_event->params.slave_security_req.mitm)
            {
                null_params = 1;
            }
            ret_code_t err_code = link_secure(p_event->conn_handle, null_params, 0, 1);
            ((void)(err_code)); 
...
static void link_secure_pending_process(ble_conn_state_user_flag_id_t flag_id)
{
    ...
    if (sdk_mapped_flags_any_set(flag_collection))
    {
        ...
        {
            _Bool pending = ble_conn_state_user_flag_get(conn_handle_list.flag_keys[i], flag_id);
            if (pending)
            {
                _Bool force_repairing = ble_conn_state_user_flag_get(conn_handle_list.flag_keys[i], m_flag_link_secure_force_repairing);
                _Bool null_params     = ble_conn_state_user_flag_get(conn_handle_list.flag_keys[i], m_flag_link_secure_null_params);

                ret_code_t err_code = link_secure(conn_handle_list.flag_keys[i], null_params, force_repairing, 1); 
                ((void)(err_code));
            }
        }
    }
...
static _Bool sec_params_verify(ble_gap_sec_params_t * p_sec_params)
{
...
ret_code_t sm_link_secure(uint16_t conn_handle, _Bool force_repairing)
{
    ...
    ret = link_secure(conn_handle, 0, force_repairing, 0);
    return ret;
}
