...
#line 13 "..\\..\\..\\..\\..\\..\\components\\libraries\\fifo\\app_fifo.c"
...
#line 17 "..\\..\\..\\..\\..\\..\\components\\libraries\\fifo\\app_fifo.c"
...
uint32_t app_fifo_read(app_fifo_t * p_fifo, uint8_t * p_byte_array, uint32_t * p_size)
{
    do { if ((((p_fifo) == 0))) { return ((0x0) + 14); } } while (0);
    do { if ((((p_size) == 0))) { return ((0x0) + 14); } } while (0);
