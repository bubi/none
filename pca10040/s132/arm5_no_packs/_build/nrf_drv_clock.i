...
#line 13 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\clock\\nrf_drv_clock.c"
...
#line 16 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\clock\\nrf_drv_clock.c"
#line 17 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\clock\\nrf_drv_clock.c"
#line 18 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\clock\\nrf_drv_clock.c"
...
;enum { assert_line_26 = 1 / (! !(((6 > 2) && (6 < 4)) || ((6 > 5) && (6 < 8)))) };
...
typedef struct
{
    _Bool                                    module_initialized;  
    volatile _Bool                           hfclk_on;            
    volatile _Bool                           lfclk_on;            
...
ret_code_t nrf_drv_clock_init(void)
{
    ...
    m_clock_cb.p_hf_head      = 0;
    m_clock_cb.hfclk_requests = 0;
    m_clock_cb.p_lf_head      = 0;
    m_clock_cb.lfclk_requests = 0;
    nrf_drv_common_irq_enable(POWER_CLOCK_IRQn, 6);
...
ret_code_t nrf_drv_clock_calibration_abort(void)
{
#line 393 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\clock\\nrf_drv_clock.c"
    return ((0x0) + 15);
...
static __inline void clock_clk_started_notify(nrf_drv_clock_evt_type_t evt_type)
{
...
#line 470 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\clock\\nrf_drv_clock.c"
}
