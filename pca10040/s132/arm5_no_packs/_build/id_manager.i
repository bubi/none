...
#line 14 "..\\..\\..\\..\\..\\..\\components\\ble\\peer_manager\\id_manager.c"
...
#line 16 "..\\..\\..\\..\\..\\..\\components\\ble\\peer_manager\\id_manager.c"
...
#line 18 "..\\..\\..\\..\\..\\..\\components\\ble\\peer_manager\\id_manager.c"
#line 19 "..\\..\\..\\..\\..\\..\\components\\ble\\peer_manager\\id_manager.c"
#line 20 "..\\..\\..\\..\\..\\..\\components\\ble\\peer_manager\\id_manager.c"
...
#line 21 "..\\..\\..\\..\\..\\..\\components\\ble\\peer_manager\\id_manager.c"
#line 22 "..\\..\\..\\..\\..\\..\\components\\ble\\peer_manager\\id_manager.c"
...
#line 23 "..\\..\\..\\..\\..\\..\\components\\ble\\peer_manager\\id_manager.c"
...
#line 24 "..\\..\\..\\..\\..\\..\\components\\ble\\peer_manager\\id_manager.c"
#line 25 "..\\..\\..\\..\\..\\..\\components\\ble\\peer_manager\\id_manager.c"
...
#line 26 "..\\..\\..\\..\\..\\..\\components\\ble\\peer_manager\\id_manager.c"
...
uint8_t new_connection(uint16_t conn_handle, ble_gap_addr_t * p_ble_addr)
{
    ...
    if ((p_ble_addr != 0) && (conn_handle != 0xFFFF))
    {
        ble_conn_state_user_flag_set(conn_handle, m_conn_state_user_flag_id, 1);
...
_Bool is_valid_irk(ble_gap_irk_t const * p_irk)
{
    (void)(p_irk != 0);
...
_Bool addr_compare(ble_gap_addr_t const * p_addr1, ble_gap_addr_t const * p_addr2)
{
    
    if ((p_addr1 == 0) || (p_addr2 == 0))
    {
        return 0;
    }
...
_Bool im_is_duplicate_bonding_data(pm_peer_data_bonding_t const * p_bonding_data1,
                                  pm_peer_data_bonding_t const * p_bonding_data2)
{
    (void)(p_bonding_data1 != 0);
    (void)(p_bonding_data2 != 0);
    ...
    _Bool duplicate_irk = (memcmp(p_bonding_data1->peer_id.id_info.irk,
                                 p_bonding_data2->peer_id.id_info.irk,
                                 16) == 0);

    _Bool duplicate_addr = addr_compare(&p_bonding_data1->peer_id.id_addr_info,
...
#line 418 "..\\..\\..\\..\\..\\..\\components\\ble\\peer_manager\\id_manager.c"
                                    ...
                                    uint32_t             * p_irk_cnt)
{
    ...
    (void)((p_gap_addrs != 0) || (p_gap_irks != 0));

    if ((p_gap_addrs != 0) && (p_addr_cnt != 0))
    {
    ...
    for (uint32_t i = 0; i < peer_cnt; i++)
    {
        ...
        if (copy_irks)
        {
            memcpy(&p_gap_irks[i], bond_data.peer_id.id_info.irk, 16);
            (*p_irk_cnt)++;
        }
    }
                                         ...
                                         uint32_t             peer_cnt)
{
        ...
        if ((p_peers == 0) || (peer_cnt == 0))
        {
            
            return sd_ble_gap_device_identities_set(0, 0, 0);
        }
        ...
        return sd_ble_gap_device_identities_set(key_ptrs, 0, peer_cnt);
...
#line 758 "..\\..\\..\\..\\..\\..\\components\\ble\\peer_manager\\id_manager.c"


ret_code_t im_id_addr_set(ble_gap_addr_t const * p_addr)
{
#line 794 "..\\..\\..\\..\\..\\..\\components\\ble\\peer_manager\\id_manager.c"
...
ret_code_t im_privacy_set(pm_privacy_params_t const * p_privacy_params)
{
#line 856 "..\\..\\..\\..\\..\\..\\components\\ble\\peer_manager\\id_manager.c"
...
ret_code_t im_privacy_get(pm_privacy_params_t * p_privacy_params)
{
#line 897 "..\\..\\..\\..\\..\\..\\components\\ble\\peer_manager\\id_manager.c"
                            ...
                            uint32_t       * p_irk_cnt)
{
    ...
    (void)((p_addrs != 0) || (p_irks != 0));
    (void)((p_addr_cnt != 0) || (p_irk_cnt != 0));

    if (((p_addr_cnt != 0) && (m_wlisted_peer_cnt > *p_addr_cnt)) ||
        ((p_irk_cnt  != 0) && (m_wlisted_peer_cnt > *p_irk_cnt)))
    {
                            ...
                            uint32_t             peer_cnt)
{
    ...
    if ((p_peers == 0) || (peer_cnt == 0))
    {
        ...
        m_wlisted_peer_cnt = 0;
            ...
            return sd_ble_gap_whitelist_set(0, 0);
    ...
    memcpy(m_wlisted_peers, p_peers, sizeof(pm_peer_id_t) * peer_cnt);
        ...
        ret = peers_id_keys_get(p_peers, peer_cnt, addrs, &wlist_addr_cnt, 0, 0);
