...
#line 14 "..\\..\\..\\..\\..\\..\\components\\ble\\peer_manager\\gatts_cache_manager.c"
...
#line 16 "..\\..\\..\\..\\..\\..\\components\\ble\\peer_manager\\gatts_cache_manager.c"
...
#line 18 "..\\..\\..\\..\\..\\..\\components\\ble\\peer_manager\\gatts_cache_manager.c"
#line 19 "..\\..\\..\\..\\..\\..\\components\\ble\\peer_manager\\gatts_cache_manager.c"
#line 20 "..\\..\\..\\..\\..\\..\\components\\ble\\peer_manager\\gatts_cache_manager.c"
...
#line 21 "..\\..\\..\\..\\..\\..\\components\\ble\\peer_manager\\gatts_cache_manager.c"
...
#line 22 "..\\..\\..\\..\\..\\..\\components\\ble\\peer_manager\\gatts_cache_manager.c"
...
#line 23 "..\\..\\..\\..\\..\\..\\components\\ble\\peer_manager\\gatts_cache_manager.c"
...
{
    for (uint32_t i = 0; i < (sizeof(m_evt_handler) / sizeof(m_evt_handler[0])); i++)
    {
...
static void service_changed_pending_set(void)
{
    ...
    static const uint32_t service_changed_pending = 1;

    
    pm_peer_data_const_t peer_data =
    {
        .data_id                   = PM_PEER_DATA_ID_SERVICE_CHANGED_PENDING,
        .length_words              = (((sizeof(_Bool)) + 3) >> 2),
        .p_service_changed_pending = (_Bool*)&service_changed_pending,
    };
    

    err_code = pdb_raw_store(m_current_sc_store_peer_id, &peer_data, 0);
...
ret_code_t gscm_local_db_cache_update(uint16_t conn_handle)
{
    ...
    else
    {
        ...
        uint16_t       n_bufs = 1;
        _Bool           retry_with_bigger_buffer = 0;

        do
        {
            retry_with_bigger_buffer = 0;
...
ret_code_t gscm_local_db_cache_apply(uint16_t conn_handle)
{
    ...
    ret_code_t           err_code;
    pm_peer_data_flash_t peer_data;
    uint8_t      const * p_sys_attr_data = 0;
    uint16_t             sys_attr_len    = 0;
    uint32_t             sys_attr_flags  = ((((1 << 0)) | ((1 << 1))));
    _Bool                 all_attributes_applied = 1;
...
ret_code_t gscm_local_db_cache_set(pm_peer_id_t peer_id, pm_peer_data_local_gatt_db_t * p_local_db)
{
    ...
    return pdb_raw_store(peer_id, &peer_data, 0);
}
...
void gscm_db_change_notification_done(pm_peer_id_t peer_id)
{
    ...
    static const uint32_t service_changed_pending = 0;
    ...
    (void) pdb_raw_store(peer_id, &peer_data, 0);
