...
#line 14 "..\\..\\..\\..\\..\\..\\components\\ble\\peer_manager\\gatt_cache_manager.c"
...
#line 16 "..\\..\\..\\..\\..\\..\\components\\ble\\peer_manager\\gatt_cache_manager.c"

#line 18 "..\\..\\..\\..\\..\\..\\components\\ble\\peer_manager\\gatt_cache_manager.c"
...
#line 19 "..\\..\\..\\..\\..\\..\\components\\ble\\peer_manager\\gatt_cache_manager.c"
#line 20 "..\\..\\..\\..\\..\\..\\components\\ble\\peer_manager\\gatt_cache_manager.c"
...
#line 21 "..\\..\\..\\..\\..\\..\\components\\ble\\peer_manager\\gatt_cache_manager.c"
...
#line 22 "..\\..\\..\\..\\..\\..\\components\\ble\\peer_manager\\gatt_cache_manager.c"
...
#line 23 "..\\..\\..\\..\\..\\..\\components\\ble\\peer_manager\\gatt_cache_manager.c"
...
#line 24 "..\\..\\..\\..\\..\\..\\components\\ble\\peer_manager\\gatt_cache_manager.c"
...
static _Bool cccd_written(ble_gatts_evt_write_t * p_write_evt)
{
...
{
    _Bool set_procedure_as_pending = 0;
    ret_code_t err_code;
    gcm_evt_t event;
...
{
    gcm_evt_t event;
    _Bool sc_pending_state = 1;
    _Bool sc_sent_state = 0;
    ...
    switch (p_event->evt_id)
    {
        ...
        case GSCM_EVT_SC_STATE_STORED:
            if (p_event->params.sc_state_stored.state)
            {
                ...
                if (conn_handle != 0xFFFF)
                {
                    ble_conn_state_user_flag_set(conn_handle, m_flag_service_changed_pending, 1);
...
void gcm_im_evt_handler(im_evt_t const * p_event)
{
    switch (p_event->evt_id)
    {
        case IM_EVT_BONDED_PEER_CONNECTED:
            ...
            {
                ble_conn_state_user_flag_set(p_event->conn_handle, m_flag_service_changed_pending, 1);
            }
            break;
        default:
            break;
...
void gcm_ble_evt_handler(ble_evt_t * p_ble_evt)
{
    ...
    switch (p_ble_evt->header.evt_id)
    {
        ...
        case BLE_GATTS_EVT_SC_CONFIRM:
            ...
            ble_conn_state_user_flag_set(p_ble_evt->evt.gatts_evt.conn_handle, m_flag_service_changed_pending, 0);
...
void gcm_local_database_has_changed(void)
{
    ...
    {
        if (im_peer_id_get_by_conn_handle(conn_handles.flag_keys[i]) == 0xFFFF)
        {
            ble_conn_state_user_flag_set(conn_handles.flag_keys[i], m_flag_service_changed_pending, 1);
        }
    }
