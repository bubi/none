...
#line 13 "..\\..\\..\\..\\..\\..\\components\\softdevice\\common\\softdevice_handler\\softdevice_handler.c"
...
#line 14 "..\\..\\..\\..\\..\\..\\components\\softdevice\\common\\softdevice_handler\\softdevice_handler.c"
#line 15 "..\\..\\..\\..\\..\\..\\components\\softdevice\\common\\softdevice_handler\\softdevice_handler.c"
#line 16 "..\\..\\..\\..\\..\\..\\components\\softdevice\\common\\softdevice_handler\\softdevice_handler.c"
#line 17 "..\\..\\..\\..\\..\\..\\components\\softdevice\\common\\softdevice_handler\\softdevice_handler.c"
...
#line 18 "..\\..\\..\\..\\..\\..\\components\\softdevice\\common\\softdevice_handler\\softdevice_handler.c"
#line 19 "..\\..\\..\\..\\..\\..\\components\\softdevice\\common\\softdevice_handler\\softdevice_handler.c"
#line 20 "..\\..\\..\\..\\..\\..\\components\\softdevice\\common\\softdevice_handler\\softdevice_handler.c"
#line 1 "..\\..\\..\\..\\..\\..\\components\\libraries\\util\\nrf_assert.h"
...
#line 21 "..\\..\\..\\..\\..\\..\\components\\softdevice\\common\\softdevice_handler\\softdevice_handler.c"
#line 1 "..\\..\\..\\..\\..\\..\\components\\softdevice\\s132\\headers\\nrf_nvic.h"
...
#line 22 "..\\..\\..\\..\\..\\..\\components\\softdevice\\common\\softdevice_handler\\softdevice_handler.c"
#line 23 "..\\..\\..\\..\\..\\..\\components\\softdevice\\common\\softdevice_handler\\softdevice_handler.c"
...
#line 24 "..\\..\\..\\..\\..\\..\\components\\softdevice\\common\\softdevice_handler\\softdevice_handler.c"
...
#line 17 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\clock\\nrf_drv_clock.h"
#line 18 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\clock\\nrf_drv_clock.h"
#line 19 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\clock\\nrf_drv_clock.h"
#line 20 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\clock\\nrf_drv_clock.h"
...
typedef enum  
{
    NRF_CLOCK_TASK_HFCLKSTART = (( size_t)__INTADDR__(&(((NRF_CLOCK_Type *)0)->TASKS_HFCLKSTART))),  
    NRF_CLOCK_TASK_HFCLKSTOP  = (( size_t)__INTADDR__(&(((NRF_CLOCK_Type *)0)->TASKS_HFCLKSTOP))),   
    NRF_CLOCK_TASK_LFCLKSTART = (( size_t)__INTADDR__(&(((NRF_CLOCK_Type *)0)->TASKS_LFCLKSTART))),  
    NRF_CLOCK_TASK_LFCLKSTOP  = (( size_t)__INTADDR__(&(((NRF_CLOCK_Type *)0)->TASKS_LFCLKSTOP))),   
    NRF_CLOCK_TASK_CAL        = (( size_t)__INTADDR__(&(((NRF_CLOCK_Type *)0)->TASKS_CAL))),         
    NRF_CLOCK_TASK_CTSTART    = (( size_t)__INTADDR__(&(((NRF_CLOCK_Type *)0)->TASKS_CTSTART))),     
    NRF_CLOCK_TASK_CTSTOP     = (( size_t)__INTADDR__(&(((NRF_CLOCK_Type *)0)->TASKS_CTSTOP)))       
} nrf_clock_task_t;                                                          
...
typedef enum  
{
    NRF_CLOCK_EVENT_HFCLKSTARTED = (( size_t)__INTADDR__(&(((NRF_CLOCK_Type *)0)->EVENTS_HFCLKSTARTED))),  
    NRF_CLOCK_EVENT_LFCLKSTARTED = (( size_t)__INTADDR__(&(((NRF_CLOCK_Type *)0)->EVENTS_LFCLKSTARTED))),  
    NRF_CLOCK_EVENT_DONE         = (( size_t)__INTADDR__(&(((NRF_CLOCK_Type *)0)->EVENTS_DONE))),          
    NRF_CLOCK_EVENT_CTTO         = (( size_t)__INTADDR__(&(((NRF_CLOCK_Type *)0)->EVENTS_CTTO)))           
} nrf_clock_event_t;                                                                
...
static __inline void nrf_clock_int_enable(uint32_t int_mask);
...
static __inline void nrf_clock_int_disable(uint32_t int_mask);
...
static __inline _Bool nrf_clock_int_enable_check(nrf_clock_int_mask_t int_mask);
...
static __inline uint32_t nrf_clock_task_address_get(nrf_clock_task_t task);
...
static __inline void nrf_clock_task_trigger(nrf_clock_task_t task);
...
static __inline uint32_t nrf_clock_event_address_get(nrf_clock_event_t event);
...
static __inline void nrf_clock_event_clear(nrf_clock_event_t event);
...
static __inline _Bool nrf_clock_event_check(nrf_clock_event_t event);
...
static __inline void nrf_clock_lf_src_set(nrf_clock_lfclk_t source);
...
static __inline nrf_clock_lfclk_t nrf_clock_lf_src_get(void);
...
static __inline nrf_clock_lfclk_t nrf_clock_lf_actv_src_get(void);
...
static __inline nrf_clock_lfclk_t nrf_clock_lf_srccopy_get(void);
...
static __inline _Bool nrf_clock_lf_is_running(void);
...
static __inline nrf_clock_start_task_status_t nrf_clock_lf_start_task_status_get(void);
...
static __inline nrf_clock_hfclk_t nrf_clock_hf_src_get(void);
...
static __inline _Bool nrf_clock_hf_is_running(nrf_clock_hfclk_t clk_src);
...
static __inline nrf_clock_start_task_status_t nrf_clock_hf_start_task_status_get(void);
...
static __inline void nrf_clock_cal_timer_timeout_set(uint32_t interval);
...
static __inline _Bool nrf_clock_int_enable_check(nrf_clock_int_mask_t int_mask)
{
    return (_Bool)(((NRF_CLOCK_Type *) 0x40000000UL)->INTENCLR & int_mask);
}
...
static __inline _Bool nrf_clock_event_check(nrf_clock_event_t event)
{
    return (_Bool)*((volatile uint32_t *)((uint8_t *)((NRF_CLOCK_Type *) 0x40000000UL) + event));
}
...
#line 21 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\clock\\nrf_drv_clock.h"
#line 22 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\clock\\nrf_drv_clock.h"
...
#line 23 "..\\..\\..\\..\\..\\..\\components\\drivers_nrf\\clock\\nrf_drv_clock.h"
...
_Bool nrf_drv_clock_lfclk_is_running(void);
...
_Bool nrf_drv_clock_hfclk_is_running(void);
...
ret_code_t nrf_drv_clock_is_calibrating(_Bool * p_is_calibrating);
...
static __inline uint32_t nrf_drv_clock_ppi_task_addr(nrf_clock_task_t task);
...
static __inline uint32_t nrf_drv_clock_ppi_event_addr(nrf_clock_event_t event);
...
#line 26 "..\\..\\..\\..\\..\\..\\components\\softdevice\\common\\softdevice_handler\\softdevice_handler.c"
...
#line 30 "..\\..\\..\\..\\..\\..\\components\\softdevice\\common\\softdevice_handler\\softdevice_handler.c"
#line 36 "..\\..\\..\\..\\..\\..\\components\\softdevice\\common\\softdevice_handler\\softdevice_handler.c"
...
#line 51 "..\\..\\..\\..\\..\\..\\components\\softdevice\\common\\softdevice_handler\\softdevice_handler.c"

static softdevice_evt_schedule_func_t m_evt_schedule_func;               

static volatile _Bool                  m_softdevice_enabled = 0;      
static volatile _Bool                  m_suspended;                       


static uint8_t                      * mp_ble_evt_buffer;                 
...
static inline _Bool isr_enable_check(IRQn_Type IRQn)
{
    return 0 != (((NVIC_Type *) ((0xE000E000UL) + 0x0100UL) )->ISER[(((uint32_t)(int32_t)IRQn) >> 5UL)] & (uint32_t)(1UL << (((uint32_t)(int32_t)IRQn) & 0x1FUL)));
}
...
#line 226 "..\\..\\..\\..\\..\\..\\components\\softdevice\\common\\softdevice_handler\\softdevice_handler.c"

        if (no_more_soc_evts)
        {
            
#line 237 "..\\..\\..\\..\\..\\..\\components\\softdevice\\common\\softdevice_handler\\softdevice_handler.c"
            
            if (no_more_ble_evts)
            {
                break;
            }
#line 253 "..\\..\\..\\..\\..\\..\\components\\softdevice\\common\\softdevice_handler\\softdevice_handler.c"
        }
    }
}
...
#line 291 "..\\..\\..\\..\\..\\..\\components\\softdevice\\common\\softdevice_handler\\softdevice_handler.c"

    m_evt_schedule_func = evt_schedule_func;

    

    _Bool power_clock_isr_enabled = isr_enable_check(POWER_CLOCK_IRQn);
    ...
    return sd_nvic_EnableIRQ((IRQn_Type)(SWI2_EGU2_IRQn));
...
uint32_t softdevice_ble_evt_handler_set(ble_evt_handler_t ble_evt_handler)
{
    do { if ((((ble_evt_handler) == 0))) { return ((0x0) + 14); } } while (0);
...
#line 372 "..\\..\\..\\..\\..\\..\\components\\softdevice\\common\\softdevice_handler\\softdevice_handler.c"


uint32_t softdevice_sys_evt_handler_set(sys_evt_handler_t sys_evt_handler)
{
    do { if ((((sys_evt_handler) == 0))) { return ((0x0) + 14); } } while (0);
...
void softdevice_handler_suspend()
{
    ...
    ret_code_t err_code = sd_nvic_DisableIRQ((IRQn_Type)(SWI2_EGU2_IRQn));
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler_bare((LOCAL_ERR_CODE)); } while (0); } } while (0);
...
void softdevice_handler_resume()
{
    ...
    err_code = sd_nvic_SetPendingIRQ((IRQn_Type)(SWI2_EGU2_IRQn));
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler_bare((LOCAL_ERR_CODE)); } while (0); } } while (0);
    err_code = sd_nvic_EnableIRQ((IRQn_Type)(SWI2_EGU2_IRQn));
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler_bare((LOCAL_ERR_CODE)); } while (0); } } while (0);
...
_Bool softdevice_handler_is_suspended()
{
    return m_suspended;
}
                                              ...
                                              ble_enable_params_t * p_ble_enable_params)
{
    ...
    p_ble_enable_params->gatts_enable_params.attr_tab_size    = 0x0000;
    p_ble_enable_params->gatts_enable_params.service_changed  = 0;
    ...
    {
        p_ble_enable_params->gap_enable_params.central_sec_count  = 1;
    }
...
{
#line 468 "..\\..\\..\\..\\..\\..\\components\\softdevice\\common\\softdevice_handler\\softdevice_handler.c"
    return ((((NRF_FICR_Type *) 0x10000000UL)->INFO . RAM) * 1024);
...
{
    uint32_t ram_end_address = (uint32_t)0x20000000;
...
#line 499 "..\\..\\..\\..\\..\\..\\components\\softdevice\\common\\softdevice_handler\\softdevice_handler.c"
    if (ram_start != sd_req_ram_start)
    {
        if ((0 >= 2U) && (2U <= 0)) { nrf_log_frontend_std_2(2U, "SDH" ":" "WARNING:" "RAM START ADDR 0x%x should be adjusted to 0x%x\r\n", ram_start, sd_req_ram_start); };


        if ((0 >= 2U) && (2U <= 0)) { nrf_log_frontend_std_1(2U, "SDH" ":" "WARNING:" "RAM SIZE should be adjusted to 0x%x \r\n", ram_end_address_get() - sd_req_ram_start); };
...
uint32_t softdevice_enable(ble_enable_params_t * p_ble_enable_params)
{
    ...
    extern uint32_t Image$$RW_IRAM1$$Base;
    const volatile uint32_t ram_start = (uint32_t) &Image$$RW_IRAM1$$Base;
#line 528 "..\\..\\..\\..\\..\\..\\components\\softdevice\\common\\softdevice_handler\\softdevice_handler.c"

    app_ram_base = ram_start;
    if ((0 >= 3U) && (3U <= 0)) { nrf_log_frontend_std_1(3U, "SDH" ":" "INFO:" "sd_ble_enable: RAM START at 0x%x\r\n", app_ram_base); };

    err_code = sd_ble_enable(p_ble_enable_params, &app_ram_base);

    if (app_ram_base != ram_start)
    {
        if ((0 >= 2U) && (2U <= 0)) { nrf_log_frontend_std_1(2U, "SDH" ":" "WARNING:" "sd_ble_enable: app_ram_base should be adjusted to 0x%x\r\n", app_ram_base); };
    ...
    {
        if ((0 >= 1U) && (1U <= 0)) { nrf_log_frontend_std_1(1U, "SDH" ":" "ERROR:" "sd_ble_enable: error 0x%x\r\n", err_code); };
    }
    return err_code;
