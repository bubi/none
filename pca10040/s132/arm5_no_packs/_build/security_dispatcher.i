...
#line 14 "..\\..\\..\\..\\..\\..\\components\\ble\\peer_manager\\security_dispatcher.c"
...
#line 16 "..\\..\\..\\..\\..\\..\\components\\ble\\peer_manager\\security_dispatcher.c"
...
#line 18 "..\\..\\..\\..\\..\\..\\components\\ble\\peer_manager\\security_dispatcher.c"
#line 19 "..\\..\\..\\..\\..\\..\\components\\ble\\peer_manager\\security_dispatcher.c"
#line 20 "..\\..\\..\\..\\..\\..\\components\\ble\\peer_manager\\security_dispatcher.c"
...
#line 21 "..\\..\\..\\..\\..\\..\\components\\ble\\peer_manager\\security_dispatcher.c"
#line 22 "..\\..\\..\\..\\..\\..\\components\\ble\\peer_manager\\security_dispatcher.c"
...
#line 23 "..\\..\\..\\..\\..\\..\\components\\ble\\peer_manager\\security_dispatcher.c"
...
#line 24 "..\\..\\..\\..\\..\\..\\components\\ble\\peer_manager\\security_dispatcher.c"
...
{
    ret_code_t                 err_code;
    ble_gap_enc_info_t const * p_enc_info = 0;
    ...
    err_code = sd_ble_gap_sec_info_reply(p_gap_evt->conn_handle, p_enc_info, 0, 0);
    ...
    else if (p_enc_info == 0)
    {
        evt.evt_id                                  = SMD_EVT_LINK_ENCRYPTION_FAILED;
        evt.params.link_encryption_failed.error     = (0x1000 + 0x06);
        evt.params.link_encryption_failed.error_src = 0x00;

        evt_send(&evt);

        sec_proc_start(p_gap_evt->conn_handle, peer_id, 0, 0, 0);
    }
    else
    {
        sec_start_send(p_gap_evt->conn_handle, PM_LINK_SECURED_PROCEDURE_ENCRYPTION);

        sec_proc_start(p_gap_evt->conn_handle, peer_id, err_code == ((0x0) + 0), 0, 0);
    }
...
static void auth_status_success_process(ble_gap_evt_t * p_gap_evt)
{
    ...
    ble_conn_state_user_flag_set(p_gap_evt->conn_handle, m_flag_sec_proc, 0);
                            ...
                            uint8_t             error_src)
{
    ...
    ble_conn_state_user_flag_set(conn_handle, m_flag_sec_proc, 0);
                            ...
                            ble_gap_lesc_p256_pk_t * p_public_key)
{
    ...
    if (err_code == ((0x0) + 0))
    {
        ...
        if (role == 0x2)
        {
            err_code = sd_ble_gap_sec_params_reply(conn_handle, sec_status, 0, &sec_keyset);
        }
        else
        {
            err_code = sd_ble_gap_sec_params_reply(conn_handle, sec_status, p_sec_params, &sec_keyset);

            if ((p_sec_params != 0) && (err_code == ((0x0) + 0)))
            {
    ...
    sec_proc_start(conn_handle,
                   peer_id,
                   (err_code == ((0x0) + 0)) && (sec_status != 0x85),
                   1,
                   new_peer_created);
                                                    ...
                                                    pm_conn_sec_procedure_t * procedure)
{
    ...
    ret_code_t                err_code;
    ble_gap_enc_key_t const * p_existing_key = 0;
    _Bool                      lesc = 0;
    ...
    if     (!force_repairing
         && (err_code == ((0x0) + 0))
         && (p_existing_key != 0)
         && (lesc || im_master_id_is_valid(&(p_existing_key->master_id))))  
    ...
    else if ((err_code == ((0x0) + 0)) || (err_code == ((0x0) + 5)))
    {
        ...
        if (err_code != ((0x0) + 0))
        {
            ...
            if ((err_code_release != ((0x0) + 0)) && (err_code_release != ((0x0) + 5)))
            {
                err_code = ((0x0) + 3);
            }
        }
                                               ...
                                               ble_gap_sec_params_t * p_sec_params)
{
    ...
    if (peer_id != 0xFFFF)
    {
        ...
        if (err_code != ((0x0) + 0))
        {
            ...
            if ((err_code_free != ((0x0) + 0)) && (err_code_free != ((0x0) + 5)))
            {
                err_code = ((0x0) + 3);
            }
        }
                                      ...
                                      _Bool                   force_repairing)
{
    ...
    if (p_sec_params == 0)
    {
        return sd_ble_gap_authenticate(conn_handle, 0);
    }
    ...
    else
    {
        ...
        sec_proc_start(conn_handle, peer_id, err_code == ((0x0) + 0), 1, 0);
    }
