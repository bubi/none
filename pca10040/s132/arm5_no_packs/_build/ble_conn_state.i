...
#line 14 "..\\..\\..\\..\\..\\..\\components\\ble\\common\\ble_conn_state.c"
#line 15 "..\\..\\..\\..\\..\\..\\components\\ble\\common\\ble_conn_state.c"
#line 16 "..\\..\\..\\..\\..\\..\\components\\ble\\common\\ble_conn_state.c"
...
#line 17 "..\\..\\..\\..\\..\\..\\components\\ble\\common\\ble_conn_state.c"
#line 18 "..\\..\\..\\..\\..\\..\\components\\ble\\common\\ble_conn_state.c"
#line 19 "..\\..\\..\\..\\..\\..\\components\\ble\\common\\ble_conn_state.c"
...
#line 20 "..\\..\\..\\..\\..\\..\\components\\ble\\common\\ble_conn_state.c"
...
typedef struct
{
    sdk_mapped_flags_t valid_flags;                                  
    sdk_mapped_flags_t connected_flags;                              
    sdk_mapped_flags_t central_flags;                                
    sdk_mapped_flags_t encrypted_flags;                              
    sdk_mapped_flags_t mitm_protected_flags;                         
    sdk_mapped_flags_t user_flags[24];      
...
typedef struct
{
    uint32_t           acquired_flags;                               
    uint16_t           valid_conn_handles[8];  
    union
    {
        ble_conn_state_flag_collections_t flags;                               
        sdk_mapped_flags_t                flag_array[(5 + 24)];  
    };
} ble_conn_state_t;
...
static _Bool user_flag_is_acquired(ble_conn_state_user_flag_id_t flag_id)
{
    ...
    switch (p_ble_evt->header.evt_id)
    {
        case BLE_GAP_EVT_CONNECTED:
            ...
            if ( !record_activate(p_ble_evt->evt.gap_evt.conn_handle) )
            {
                ...
                do { app_error_handler_bare((((0x0) + 4))); } while (0);
            }
            else
            {
                _Bool is_central =
                        (p_ble_evt->evt.gap_evt.params.connected.role == 0x2);
...
uint8_t ble_conn_state_role(uint16_t conn_handle)
{
    ...
    {
        _Bool central = sdk_mapped_flags_get_by_key(m_bcs.valid_conn_handles,
                                                   m_bcs.flags.central_flags,
                                                   conn_handle);
...
ble_conn_state_status_t ble_conn_state_status(uint16_t conn_handle)
{
    ...
    _Bool valid = sdk_mapped_flags_get_by_key(m_bcs.valid_conn_handles,
                                             m_bcs.flags.valid_flags,
                                             conn_handle);

    if (valid)
    {
        _Bool connected = sdk_mapped_flags_get_by_key(m_bcs.valid_conn_handles,
                                                     m_bcs.flags.connected_flags,
                                                     conn_handle);
